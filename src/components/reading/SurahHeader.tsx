...
export function SurahHeader({ chapter }: { chapter: Chapter }) {
  return (
    <div className="grid grid-cols-1 items-center px-6 py-5 tablet:grid-cols-3 gap-y-4 border-b border-zinc-800">
      ...
      <div className="space-y-2 text-center">
        <h1 className="text-xl font-semibold text-zinc-100 lg:text-2xl">
